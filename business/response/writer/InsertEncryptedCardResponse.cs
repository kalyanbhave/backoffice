...
namespace SafeNetWS.business.response.writer
{
     ...
     * 
     */
    public class InsertEncryptedCardResponse
    {
        ...
        public InsertEncryptedCardResponse(string pan)
        {
            // Initialisation
        ...
        public void SetValues(UserInfo useri, InsertCardInEncryptedDBResult res)
        {
            SetUser(useri);
