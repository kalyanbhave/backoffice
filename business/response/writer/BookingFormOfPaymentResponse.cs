...
namespace SafeNetWS.business.response.writer
{
    ...
    ///             <CardNumber>492957XXXXXX4263</CardNumber>
    ...
    /// 
    /// </summary>
    public class BookingFormOfPaymentResponse
    {
        ...
        // --> Corporation
        private const string Xml_Corporation_Open_Tag = "<Corporation>";
        private const string Xml_Corporation_Close_Tag = "</Corporation>";
        // --> CostCenter
        ...
        private string argCorporation;
        private string argToken;

        private string paymentType;

        // Result from Navision WS
        private ExtendedPanInfoResult extendedPanInfos;
        private FOPanInfoResult fOPanInfos;
        private TravelerPaymentMeansResponse travelerPaymentMeanResponse;
       ...
       {
           return String.Format("pos = {0}, comcode = {1}, percode = {2}, service = {3}, corporation = {4}, token = {5}", GetArgPos()
               ,GetArgComcode(), GetArgPercode(), GetArgService(), GetArgCorporation(), GetArgToken());
       }
       /// <summary>
       ...
       /// </summary>
       /// <returns>Marché</returns>
       public string GetArgService()
       {
           return this.argService;
       }
       ...
       public string GetArgToken()
       {
           return this.argToken;
       }
       ...
       public string GetArgCorporation()
       {
           return this.argCorporation;
       }

        /// <summary>
        /// Build traveler paymentmeans response
        /// </summary>
       public void BuildTravelerPaymentMeansResponse()
       {
           this.travelerPaymentMeanResponse = new TravelerPaymentMeansResponse(GetArgPos(), GetArgComcode(), GetArgCostCenter(), GetArgPercode(), GetArgService());
           // Set user
           this.travelerPaymentMeanResponse.SetUser(GetUser());
       }

       /// <summary>
       /// Returns traveler payment means
       /// </summary>
       /// <returns>traveler payment means</returns>
       public TravelerPaymentMeansResponse GetTravelerPaymentMeansResponse()
       {
           return this.travelerPaymentMeanResponse;
       }
