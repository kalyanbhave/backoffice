...
namespace SafeNetWS.business.response.writer
{
   ...
   /// </summary> 
    ...
    public class EncryptFileResponse
    {
        ...
        // Statut sur l'encryption
        // en réalité il n'y a qu'un seul statut "OK"
        // L'encryption a été réalisée avec succès
        ...
        public EncryptFileResponse(string plainTextFileName, string encryptedFileName)
        {
            // Initialisation
        ...
        private string GetPlainTextFileName()
        {
        ...
        /// <summary>
        /// Retourne le contenu du fichier encrypté
        /// </summary>
        /// <returns>Contenu du fichier encrypté</returns>
       ...
       private void LogResponse()
       {
           Services.WriteOperationStatusToLog(GetUser(), 
               String.Format(" and provided to encrypt filename ={0}", GetPlainTextFileName()),
