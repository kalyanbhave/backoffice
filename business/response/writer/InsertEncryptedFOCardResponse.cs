...
namespace SafeNetWS.business.response.writer
{
     ...
     * par la méthode d'insertion des cartes dans la base des données encryptées
     ...
     *      <ShortExpirationDate>Valeur de retour</ShortExpirationDate>
     ...
     * 
     */
    public class InsertEncryptedFOCardResponse
    {
        ...
        public InsertEncryptedFOCardResponse(string pan)
        {
            // Initialisation
        ...
        public void SetValues(UserInfo useri, InsertCardInEncryptedFODBResult res)
        {
            SetUser(useri);
            ...
            this.InformationCode = res.GetInformationCode();
            this.InformationMessage = res.GetInformationMessage();
        }
        ...
        /// <summary>
        /// Retourne le code du message d'information
        /// </summary>
        /// <returns>Code information</returns>
        private string GetInformationCode()
        {
