...
namespace SafeNetWS.business.response.writer
{
    ...
    ///  
    /// </summary> 
    public class ENettAmendVANResponse
    {
        ...
        private const string Xml_Response_Open_Tag = "<AmendVANResponse>";
        private const string Xml_Response_Close_Tag = "</AmendVANResponse>";
        ...
        public ENettAmendVANResponse(string requestorDetail)
        {
