...
namespace SafeNetWS.business.response.writer
{
   ...
   /// </summary> 
    ...
    public class DecryptFileResponse
    {
        ...
        public DecryptFileResponse(string filename)
        {
            // Initialisation
        ...
        /// <summary>
        /// Retourne le contenu du fichier décrypté
        /// </summary>
        /// <returns>Contenu du fichier décrypté</returns>
        private string GetDecryptedFileContent()
        {
            return this.decryptedFileContent;
        }

        public void SetValue(string value)
        {
            this.decryptedFileContent = value;
        }
       ...
       {
           return String.Format("Status ={0}.", Const.Success);
       }
       ...
       private void LogResponse()
       {
           Services.WriteOperationStatusToLog(GetUser(), 
               String.Format(" and provided to decrypt filename ={0}", GetFilename()),
