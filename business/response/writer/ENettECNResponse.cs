...
namespace SafeNetWS.business.response.writer
{
   ...
   /// par la méthode d'encryption de fichiers
   ...
   ///    <Value>
    ///      <RequestorECN></RequestorECN>
    ///      <IntegratorCode></IntegratorCode>
    ///      <IntegratorAccessKey></IntegratorAccessKey>
   ...
   /// </summary> 
    ...
    public class ENettECNResponse
    {
        ...
        private const string Xml_Response_RequestorECN_Open_Tag = "<RequestorECN>";
        private const string Xml_Response_RequestorECN_Close_Tag = "</RequestorECN>";
        private const string Xml_Response_IntegratorCode_Open_Tag = "<IntegratorCode>";
        private const string Xml_Response_IntegratorCode_Close_Tag = "</IntegratorCode>";
        private const string Xml_Response_IntegratorAccessKey_Open_Tag = "<IntegratorAccessKey>";
        private const string Xml_Response_IntegratorAccessKey_Close_Tag = "</IntegratorAccessKey>";
        private const string Xml_Response_ClientAccessKey_Open_Tag = "<ClientAccessKey>";
        private const string Xml_Response_ClientAccessKey_Close_Tag = "</ClientAccessKey>";
        ...
        public ENettECNResponse(int RequestorECN)
        {
            // Initialisation
        ...
        public void SetValues(ENettECNRequestorResult result)
        {
            this.IntegratorCode = result.GetIntegratorCode();
            this.IntegratorAccessKey = result.GetIntegratorAccessKey();
            this.ClientAccessKey = result.GetClientAccessKey();
        }
        ...
        private int GetRequestorECN()
        {
            return this.RequestorECN;
        }
        private string GetIntegratorCode()
        {
            return this.IntegratorCode;
        }
        private string GetIntegratorAccessKey()
        {
            return this.IntegratorAccessKey;
        }
        private string GetClientAccessKey()
        {
        ...
        public string GetResponse()
        {
            ...
            if (!IsError())
            {
                ...
                Xml_Response_Value_Open_Tag
                    + Xml_Response_Value_Open_Tag
                       + Xml_Response_RequestorECN_Open_Tag
                        + GetRequestorECN()
                       + Xml_Response_RequestorECN_Close_Tag

                       + Xml_Response_IntegratorCode_Open_Tag
                        + GetIntegratorCode()
                       + Xml_Response_IntegratorCode_Close_Tag

                       + Xml_Response_IntegratorAccessKey_Open_Tag
                         + GetIntegratorAccessKey()
                       + Xml_Response_IntegratorAccessKey_Close_Tag


                       + Xml_Response_ClientAccessKey_Open_Tag
                          + GetClientAccessKey()
                       + Xml_Response_ClientAccessKey_Close_Tag
       ...
       {
           return String.Format("requestor ECN ={0}.", GetRequestorECN());
       }
       ...
       private void LogResponse()
       {
           Services.WriteOperationStatusToLog(GetUser(),
               String.Format(" and provided requestor ECN ={0}", GetRequestorECN()),
