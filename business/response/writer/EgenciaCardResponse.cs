...
namespace SafeNetWS.business.response.writer
{
    ...
    /// par la méthode de récupération du PAN et du CSC 
    /// depui un token pour une carte Egencia
    ...
    public class EgenciaCardResponse
    {
        ...
        // Value CSC to return (serialized into string)
        private const string Xml_Response_CSC_Open_Tag = "<CSC>";
        private const string Xml_Response_CSC_Close_Tag = "</CSC>";
        ...
        public EgenciaCardResponse(string input_token)
        {
            // Initialisation
        ...
        public void SetValues(UserInfo useri, EgenciaPanInfoResult res)
        {
            SetUser(useri);
            this.PAN = res.GetPAN();
                ...
                if(this.ExceptionCount==0)
                 {
                    ...
                    strData+= 
                      Xml_Response_Value_Open_Tag
                        ...
                        + Xml_Response_CSC_Open_Tag
                            + this.CSC
                        + Xml_Response_CSC_Close_Tag
