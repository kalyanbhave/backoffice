...
namespace SafeNetWS.business.response.writer
{
   ...
   /// </summary> 
    ...
    public class TokenValidationResponse
    {
        ...
        public TokenValidationResponse(string token)
        {
            // Initialisation
        ...
        /// </summary>
        /// <returns>Type der paiement</returns>
        ...
        {
            this.Status=value == true ? "VALID" : "UNVALID";
        }
       ...
       {
           return String.Format("Status ={0}.", GetStatus());
       }
       ...
       private void LogResponse()
       {
           Services.WriteOperationStatusToLog(GetUser(), 
               String.Format(" and provided token ={0}", GetToken()),
