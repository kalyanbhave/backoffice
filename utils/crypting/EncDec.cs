...
namespace SafeNetWS.utils.crypting
{
    // 
    ...
    public class EncDec
    {
        private static string SECRETE_KEY = ConfigurationManager.AppSettings["ConnStringSecretKey"];

        public static string EncryptPassword(string cleanPassword)
        {
            return Encrypt(cleanPassword, SECRETE_KEY);
        }
        public static string DecryptPassword(string cipherPassword)
        {
            return Decrypt(cipherPassword, SECRETE_KEY);
        }
        ...
        private static void CloseMemoryStream(MemoryStream mem)
        {
            if (mem != null)
            {
                mem.Dispose();
        ...
        private static void CloseCryptoStream(CryptoStream crypt)
        {
            if (crypt != null)
            {
                crypt.Dispose();
